...
function getRequiredSepoliaVar(name: string): string {
  if (!isSepoliaCommand) return "";
  return vars.get(name);
}

const MNEMONIC: string = isSepoliaCommand ? getRequiredSepoliaVar("MNEMONIC") : vars.get("MNEMONIC", LOCAL_MNEMONIC);
const INFURA_API_KEY: string = getRequiredSepoliaVar("INFURA_API_KEY");
